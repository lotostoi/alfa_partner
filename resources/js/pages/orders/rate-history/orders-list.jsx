    ...
    return (
        <div className={style.orderlist}>
            <div className={style.orderlist__topgroup}>
                <div className={[style.orderlist__filters, 'row'].join(" ")}>
            ...
            <div className={style.orderlist__table} style={{ margin: '24px 0 40px' }}>
                <div className={[style['orderlist__table-topgroup'], 'd-flex'].join(' ')}>
                    <h2 className={style['orderlist__table-title']}>Дебетовая карта Пятерочка</h2>
                    <IconButton
                        className={[style['orderlist__table-expand'], 'ms-auto'].join(" ")}
                        view='primary'
            ...
            <div className={style.orderlist__table} style={{ margin: '24px 0 40px' }}>
                <div className={[style['orderlist__table-topgroup'], 'd-flex'].join(" ")}>
                    <h2 className={style['orderlist__table-title']}>Дебетовая карта Альфа карта</h2>
                    <IconButton
                        className={[style['orderlist__table-expand'], 'ms-auto'].join(" ")}
                        view='primary'
                        icon={ExpandDownMBlackIcon}
