...
export default function ({toggleFilter}) {
    ...
    return (
        <div className={style.order_list}>
            <div className={style.order_list_top_group}>
                <div className={style.order_list_btns}>
                    <Button
                ...
                <div className={style.order_list_settings}>
                    <Button
            ...
            <div className={style.order_list__table} style={{ margin: '24px 0 40px' }}>
                <Table
                    wrapper={false}
                    pagination={
                        <Table.Pagination
